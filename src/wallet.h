...
public:
    ...
    void adChanged(const CTransaction& tx, const CBlock* const pblock, const bool fConnectOrDisconnect);
    ...
    /// Called on ad added, removed or updated.
    boost::signals2::signal<void (const uint256 &hashTx, ChangeType status)> NotifyAdChanged;
};
