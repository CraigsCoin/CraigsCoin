...
CBigNum bnProofOfStakeLimit(~uint256(0) >> 5);
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Pro-Russia rebels in Ukraine agree to open a humanitarian corridor...";
        CTransaction txNew;
        txNew.nTime = 1409320652;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("71dcc778b5c42a0087c85691103211ad8a1bacb9b1dda01c33abfe69a2a5802e"));
        block.print();
